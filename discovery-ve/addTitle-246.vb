...
rule "Primo VE - addtitle - 1st ind 0"
	when
		MARC."246" has any "a-p" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 3"
	when
		MARC."246" has any "a-p" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd null"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 0"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 1"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 2"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 4"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 5"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 6"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 7"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 1st 1, 2nd 8"
	when
		MARC."246" has any "a-p" AND 
		MARC."246".ind"1" equals "1" AND 
...
rule "Primo VE - addtitle - 247"
	...
	then
		create pnx."display"."addtitle" with MARC."247" sub without sort "a-p"
end

// begin 880

rule "Primo VE - addtitle - 246-880"
	when
		MARC."880" has any "a-p" AND
		MARC."880"."6" match "246-.*"  
	then
		create pnx."display"."addtitle" with MARC "880" sub without sort "a-p"
end

rule "Primo VE - addtitle - 247-880"
	when
		MARC."880" has any "a-p" AND
