rule "Primo VE - Uniform Title 130"
	...
	then
		...
		set TEMP"4" to MARC."130" sub without sort "a,d,g,h,k,m-t"
...
rule "Primo VE - Uniform Title 240"
	...
	then
		...
		set TEMP"4" to MARC."240" sub without sort "a,d,g,h,k,m-t"
		remove substring using regex (TEMP"4","(;|,|\\.)+$")
		concatenate with delimiter (TEMP"1",TEMP"4","$$Q")
		create pnx."display"."unititle" with TEMP"1"	
end
...
rule "Primo VE - Uniform Title 243"
	when
		MARC is "243"
	then
		set TEMP"1" to MARC."243" excluding num subfields without sort
		set TEMP"4" to MARC."243" sub without sort "a,d,g,h,k,m-t"
		remove substring using regex (TEMP"4","(;|,|\\.)+$")
		concatenate with delimiter (TEMP"1",TEMP"4","$$Q")
		create pnx."display"."unititle" with TEMP"1"	
end
