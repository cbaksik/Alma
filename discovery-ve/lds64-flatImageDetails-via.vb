rule "Primo VE - Lds64"
	...
	then		
		set TEMP"1" to MARC."598" sub without sort "w"               
		add prefix (TEMP"1","ID: ")	

		set TEMP"2" to MARC."598" sub without sort "t"               
		add prefix (TEMP"2","Title: ")	
		...
		set TEMP"9" to MARC."598" sub without sort "g"
		add prefix (TEMP"9","Type: ")
...
// ID must be first to gurantee fields is created
