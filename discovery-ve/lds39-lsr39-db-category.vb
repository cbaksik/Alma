rule "Primo VE Marc - Lsr39"
	...
	then
		...
		replace string by string (TEMP"1","gen-arts-hvd-db-sub","General - Arts and Humanities")
		replace string by string (TEMP"1","gen-reg-hvd-db-sub","General - Regional and Cultural Studies")
		replace string by string (TEMP"1","gen-sci-hvd-db-sub","General - Science and Technology")
		replace string by string (TEMP"1","gen-soc-hvd-db-sub","General - Social Science")
		...
		create pnx."search"."lsr39" with TEMP"1"
end