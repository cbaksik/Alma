rule "Primo VE - Lds06"
	...
	then
		...
		set TEMP"4" to MARC."700" sub without sort "a,b,c,q,d"
...
rule "Primo VE - Lds06 - 710"
	...
	then
		...
		concatenate with delimiter (TEMP"1",TEMP"3"," -- ")
		set TEMP"4" to MARC."710" sub without sort "i,a,b,t,c,d,g,k,n,p"
		remove substring using regex (TEMP"4","(;|,|\\.)+$")
		add prefix (TEMP"4","$$Q")
		concatenate with delimiter (TEMP"1",TEMP"4","")
		create pnx."display"."lds06" with TEMP"1"
...
rule "Primo VE - Lds06 - 711"
	...
	then
		...
		add suffix (TEMP"2","]")
		concatenate with delimiter (TEMP"1",TEMP"2"," ")
		set TEMP"4" to MARC."711" sub without sort "a-f,k,l,n,p,q,s,t,u"
		remove substring using regex (TEMP"4","(;|,|\\.)+$")
		add prefix (TEMP"4","$$Q")
		concatenate with delimiter (TEMP"1",TEMP"4","")
		create pnx."display"."lds06" with TEMP"1"
